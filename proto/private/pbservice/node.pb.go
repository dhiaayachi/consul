...
// mog annotation:
//
// target=github.com/dhiaayachi/consul/agent/structs.Node
// output=node.gen.go
// name=Structs
type Node struct {
	state         protoimpl.MessageState
...
// mog annotation:
//
// target=github.com/dhiaayachi/consul/agent/structs.NodeService
// output=node.gen.go
// name=Structs
...
func file_private_pbservice_node_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_private_pbservice_node_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_private_pbservice_node_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_private_pbservice_node_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
		...
		file_private_pbservice_node_proto_msgTypes[3].Exporter = func(v any, i int) any {
