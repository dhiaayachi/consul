...
// mog annotation:
//
// target=github.com/dhiaayachi/consul/agent/structs.RaftIndex
...
// mog annotation:
//
// target=github.com/dhiaayachi/consul/agent/structs.WriteRequest
// output=common.gen.go
// name=Structs
// ignore-fields=state,sizeCache,unknownFields
...
// mog annotation:
//
// target=github.com/dhiaayachi/consul/agent/structs.QueryOptions
// output=common.gen.go
// name=Structs
...
// mog annotation:
//
// target=github.com/dhiaayachi/consul/agent/structs.QueryMeta
// output=common.gen.go
// name=Structs
...
// mog annotation:
//
// target=github.com/dhiaayachi/consul/agent/structs.EnvoyExtension
// output=common.gen.go
// name=Structs
...
// mog annotation:
//
// target=github.com/dhiaayachi/consul/agent/structs.Locality
// output=common.gen.go
// name=Structs
...
func file_private_pbcommon_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_private_pbcommon_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_private_pbcommon_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_private_pbcommon_common_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_private_pbcommon_common_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_private_pbcommon_common_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_private_pbcommon_common_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_private_pbcommon_common_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_private_pbcommon_common_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_private_pbcommon_common_proto_msgTypes[8].Exporter = func(v any, i int) any {
