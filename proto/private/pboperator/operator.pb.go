...
func file_private_pboperator_operator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_private_pboperator_operator_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_private_pboperator_operator_proto_msgTypes[1].Exporter = func(v any, i int) any {
