...
import (
	...
	pbconnect "github.com/dhiaayachi/consul/proto/private/pbconnect"
...
func file_private_pbautoconf_auto_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_private_pbautoconf_auto_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_private_pbautoconf_auto_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
