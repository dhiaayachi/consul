...
func (L LLMAgentExternalServersConfigEntry) GetPartition() string {
	return L.Partition
}

func (L LLMAgentExternalServersConfigEntry) GetNamespace() string {
	return L.Namespace
}
...
func (L LLMAgentExternalServersConfigEntry) GetCreateIndex() uint64 {
	return L.CreateIndex
}

func (L LLMAgentExternalServersConfigEntry) GetModifyIndex() uint64 {
	return L.ModifyIndex
}
