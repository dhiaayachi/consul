...
func file_pbmulticluster_v2_computed_exported_services_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbmulticluster_v2_computed_exported_services_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pbmulticluster_v2_computed_exported_services_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pbmulticluster_v2_computed_exported_services_proto_msgTypes[2].Exporter = func(v any, i int) any {
